<html>
    ...
    <body bgcolor='#DBEFFF' >
        ...
        <div class="container" style="background-color: white;width: 370px;height: 450px;margin-left: auto;margin-right: auto;margin-top: 45px;margin-bottom: 50px;opacity: 95%">
            ...
            <form action="UpdateCompany_1_1.jsp">
            <table width="100%">
                <tr>
                    <td><img src="images/id.png" class="maintext" width="200px" style="padding-bottom: 100px;padding-left: 10px"></td>
                </tr> 
               
                 <tr>
                    <td class="maintext texthead" style="white-space: nowrap;top:33%;font-size: 18px;word-spacing: 3px;color: black">SET NEW COMPANY ID</td>
                </tr>
                ...
                <tr>
                    <td class="maintext" style="top: 48%">
                        <input class="ifield"  type="text"  name="new" placeholder="New Company Id" style="width: 250px;height: 25px" >
                    </td>
                </tr>
                <tr>
                    <td class="maintext" style="top: 55%">
                        <input  class="ifield" type="text"  name="confirm" placeholder="Confirm Company Id" style="width: 250px;height: 25px" >
                    </td>
                </tr>
