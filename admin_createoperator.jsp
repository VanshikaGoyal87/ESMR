<html>
    ...
    <body bgcolor='#DBEFFF' >
        ...
        <div class="container" style="background-color:white;width: 370px;height: 480px;margin-left: auto;margin-right: auto;margin-top: 45px;margin-bottom: 60px;opacity: 95%">
            <form action="InsertOperator.jsp">
            <table width="100%">
                <tr>
                    <td class="maintext texthead" style="color: black;font-weight: bold;padding-bottom: 190px;font-size:22px;white-space: nowrap">CREATE OPERATOR</td>
                </tr>
                <tr>
                    <td class="maintext " style="top: 15%">
                        <input class="ifield" type="text" name="id" placeholder="Operator Id" style="width: 250px;height: 25px" >
                    </td>
                </tr>
                ...
                <tr>
                    <td class="maintext " style="top:29%">
                        <input class="ifield" type="text" name="name" placeholder="Operator name" style="width: 250px;height: 25px" >
                    </td>
                </tr>
                <tr>
