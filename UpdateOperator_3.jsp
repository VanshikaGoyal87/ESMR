...
<%@page import = "java.sql.DriverManager" %>
        ...
        PreparedStatement st=con.prepareStatement("select* from operator_table where operator_id=?");
        ...
        PreparedStatement st1= con.prepareStatement("update operator_table set operator_id=? where operator_id=? ");
