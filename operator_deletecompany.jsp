<html>
    ...
    <body bgcolor='#DBEFFF' >
        ...
        <div class="container" style="background-color: white;width: 370px;height: 400px;margin-left: auto;margin-right: auto;margin-top: 45px;margin-bottom: 50px;opacity: 95%">
            ...
            <form action="DeleteCompany_1.jsp">
            <table width="100%">
                <tr>
                 ...
                 <tr>
                    <td class="maintext texthead" style="white-space: nowrap;top:37%;font-size: 18px;word-spacing: 3px;color: black">DELETE COMPANY</td>
                </tr>
            
                <tr>
                    <td class="maintext" style="top: 49%">
                        <input class="ifield" type="text"  name="ID" placeholder="Company ID" style="width: 250px;height: 25px" >
                    </td>
                </tr>
               <tr>
