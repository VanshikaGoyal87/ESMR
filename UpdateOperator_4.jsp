...
<%@page import = "java.sql.DriverManager" %>
        ...
        PreparedStatement st=con.prepareStatement("select* from operator_table where operator_id=? and operator_password=?");
        ...
        PreparedStatement st1= con.prepareStatement("update operator_table set operator_password=? where operator_id=? ");
