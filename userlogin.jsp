<html>
    ...
    <body bgcolor='#DBEFFF' >
        ...
        <div class="container" style="background-color: #3CA4E3;width: 370px;height: 480px;margin-left: auto;margin-right: auto;margin-top: 45px;margin-bottom: 50px;opacity: 95%">
            ...
            <table width="100%">
                <tr>
                    <td><img src="images/user_icon.png" class="maintext" width="200px" style="padding-bottom: 100px;padding-left: 10px"></td>
                </tr> 
                <tr>
                    <td class="maintext texthead" style="color: white;font-weight: bold;top: 140px;">USER LOGIN</td>
                </tr>
                <%
                    String name="";
                    ...
                    if(ck[i].getName().equals("dynamic"))
                    name=ck[i].getValue();
                    }
                    %>
                <tr>
                ...
                <tr>
                    <td class="maintext" style="top: 58%"><a href="forgetpassword.jsp" style="color: #404040;font-style: italic;text-decoration: none;font-size: 12px;padding-left: 150px;white-space: nowrap">Forgot Password?</a></td>
                </tr>
                <tr>
               ...
               <tr><td style="border-bottom: 2px solid white;padding-top: 105px"></td></tr>
                ...
                <tr>
                    <td class="maintext texthead" style="white-space: nowrap;top:90%;font-size: 18px">Not a member?<a style="text-decoration: none;color:#99071A" href="usersignup.jsp"> Create Account</a></td>
                </tr>
            </table>
            </form>
