<html>
    ...
    <body bgcolor='#DBEFFF' >
        ...
        <div class="container" style="background-color: white;width: 370px;height: 450px;margin-left: auto;margin-right: auto;margin-top: 45px;margin-bottom: 50px;opacity: 95%">
            ...
            <form action="UpdateComplaintOperator_3.jsp">
            <table width="100%">
                <tr>
                 ...
                 <tr>
                    <td class="maintext texthead" style="white-space: nowrap;top:33%;font-size: 18px;word-spacing: 3px;color: black">SET NEW CO-OPERATOR ID</td>
                </tr>
                ...
                <tr>
                    <td class="maintext" style="top: 48%">
                        <input class="ifield"  type="text"  name="new" placeholder="New Co-Opeartor Id" style="width: 250px;height: 25px" >
                    </td>
                </tr>
                <tr>
                    <td class="maintext" style="top: 55%">
                        <input  class="ifield" type="text"  name="confirm" placeholder="Confirm Co-Operator Id" style="width: 250px;height: 25px" >
                    </td>
                </tr>
