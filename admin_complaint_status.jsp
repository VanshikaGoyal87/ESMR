<html>
    ...
    <body bgcolor='#DBEFFF' >
        ...
        <div class="container" style="background-color: white;width: 370px;height: 500px;margin-left: auto;margin-right: auto;margin-top: 45px;margin-bottom: 50px;opacity: 95%">
            ...
            <form action="UpdateComplaint_1_1.jsp">
            <table width="100%">
                <tr>
                    <td><img src="images/33.png" class="maintext" width="200px" style="padding-bottom: 100px;padding-left: 10px"></td>
                </tr> 
               
                 <tr>
                    <td class="maintext texthead" style="white-space: nowrap;top:35%;font-size: 18px;word-spacing: 3px;color: black">UPDATE COMPLAINT STATUS</td>
                </tr>
