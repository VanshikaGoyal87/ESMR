<html>
    ...
    <body bgcolor='#DBEFFF' >
        ...
        <div class="container" style="background-color: #3CA4E3;width: 370px;height: 480px;margin-left: auto;margin-right: auto;margin-top: 45px;margin-bottom: 50px;opacity: 95%">
            <form action="SearchOperator.jsp">
            <table width="100%">
                <tr>
                    <td><img src="images/operator_icon.png" class="maintext" width="200px" style="padding-bottom: 100px;padding-left: 10px"></td>
                </tr>
                <tr>
                    <td class="maintext texthead" style="color: white;font-weight: bold;top: 140px;word-spacing: 4px;text-shadow: 0px 2px black">OPERATOR LOGIN</td>
                </tr>
                <tr>
                    <td class="maintext" style="top: 40%">
                        <input type="text" name="opId" placeholder="Operator Id" style="width: 250px;height: 25px" >
                    </td>
                </tr>
                <tr>
