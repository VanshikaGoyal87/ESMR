...
<%@page import = "java.sql.DriverManager" %>
        ...
        PreparedStatement st=con.prepareStatement("select* from complainoperator_table where complain_operator_Id=?");
        ...
        PreparedStatement st1= con.prepareStatement("update complainoperator_table set complain_operator_Id=? where complain_operator_Id=? ");
